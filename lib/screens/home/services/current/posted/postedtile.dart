...
class PostedTile extends StatefulWidget {
  final Post post;
  final String status;
  final String uid;

  PostedTile({this.post, this.status, this.uid});
  @override
  _PostedTileState createState() => _PostedTileState();
}

class _PostedTileState extends State<PostedTile> {
  final AuthService _auth = new AuthService();

  @override
  Widget build(BuildContext context) {
    print('${widget.post.userid} == ${widget.uid}');

    return widget.status == widget.post.status &&
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: ListTile(
                    ...
                    trailing: trailing(widget.status),
                  ),
                ),
              ),
            ),
